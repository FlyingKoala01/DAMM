...
if os.path.exists('app/damm.db'):
    print("Estás a punto de eliminar la base de datos. Volver a crearla es una operación MUY LENTA (dura DÍAS).")
    input("Presiona ENTER para proceder, Ctrl+C para cancelar.")
